...
def about(request):
    ...
    return HttpResponse(f'view count ={num}')from django.shortcuts import render,HttpResponse
from .models import NewsList
...
def home(request):
    ...
    return render(request, 'first_page/articles.html', {'rows':page_obj,'paginator':paginator,'page_num':page_num,
                                                ...
                                                'title_contains':title_contains,'date_min':date_min,'date_max':date_max ,'title_or_author':title_or_author})
